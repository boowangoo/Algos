...
void insertion_sort(vector<int>& values, const int order = 1) {
    size_t i, j;
    int currentValue;
...
void timsort(vector<int>& values, const int order = 1, const bool to_show_state = false) {
...
int main() {
    ...
    timsort(values, order, to_show_state);
